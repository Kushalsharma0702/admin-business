import { K as jsxRuntimeExports, V as reactExports, i as createServerFn, T as TSS_SERVER_FUNCTION, R as React, y as getServerFnById } from "./index.mjs";
import { L as ListPage } from "./ListPage-DwCHn9Xa.mjs";
import { a as useAppStore, u as uid } from "./useAppStore-DqzUQQt1.mjs";
import { B as Button, a as cva, c as createSlot$2 } from "./button-A6qM_v8i.mjs";
import { I as Input } from "./input-CsecQHmO.mjs";
import { T as Textarea } from "./textarea-Dyd8-Pa9.mjs";
import { r as reactDomExports } from "./router-CxdnWRBk.mjs";
import { t as toast, a as cn$1, u as useComposedRefs, b as composeRefs } from "./index-De8JtfrF.mjs";
import { u as useControllableState, P as Primitive$1, e as useLayoutEffect2, c as composeEventHandlers, b as createContextScope } from "./index-BSEENsC1.mjs";
import { m as useId, h as Portal$1, u as useCallbackRef$1, k as hideOthers, l as useFocusGuards, R as ReactRemoveScroll, g as FocusScope, f as DismissableLayer } from "./dialog-iHg5lQpM.mjs";
import { u as usePrevious, a as useSize } from "./index-CjC7qu5-.mjs";
import { C as ChevronDown, a as ChevronUp } from "./chevron-up-DC1ELb_B.mjs";
...
import { C as Card, a as CardContent } from "./card-CDOUGn8L.mjs";
import { U as Upload } from "./upload-Jt8yCBgQ.mjs";
import { S as Search } from "./AppShell-BCNUyQp7.mjs";
...
const MoveRight = createLucideIcon("move-right", __iconNode$1);
const __iconNode = [
  [
    "path",
    {
...
const Label$1 = reactExports.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsx(Root$2, { ref, className: cn$1(labelVariants(), className), ...props }));
...
const extractInvoiceText = createServerFn({
  method: "POST"
}).handler(createSsrRpc("a5df2aa3bf7578996b06e3864a107af9c34ab84116685c3abc81ac3f4447536e"));
...
function findDocumentReference(text) {
  const m = text.match(
...
function OCRUploader() {
  ...
  const [savedReceiptId, setSavedReceiptId] = reactExports.useState("");
  const paymentMethodLabel = reactExports.useMemo(() => {
  ...
  const runOCR = async () => {
    ...
    try {
      ...
      const total = findAmountByLabel(text, ["total", "amount", "balance due"]) || findLargestAmount(text);
      const tax = findAmountByLabel(text, ["tax", "vat", "gst", "hst"]) || 0;
      const net = findAmountByLabel(text, ["subtotal", "net"]) || Math.max(total - tax, 0);
      const lineParts = text.split(/\r?\n/).map((line) => line.trim()).filter((line) => line.length > 4);
      setFields({
        type,
        date: findDate(text) || (/* @__PURE__ */ new Date()).toISOString().slice(0, 10),
  ...
  const save = (status) => {
    ...
    const receipt = {
      ...
      paymentCardLast4: paymentLast4 || void 0,
      total,
      tax,
      netAmount: net,
      status,
    ...
    addCost({
      ...
      status: status === "To review" ? "To review" : status === "Ready" ? "Ready" : "Processing",
      owner: "Angela Martin"
    });
    setSavedReceiptId(receiptId);
    toast.success(`Saved and moved to ${status}.`);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-4 lg:grid-cols-[2fr_1fr]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-border bg-[#2f3d4f]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3 flex flex-wrap items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "inline-flex cursor-pointer items-center gap-2 rounded-md border border-white/20 bg-white/10 px-3 py-1.5 text-sm text-white", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", variant: "outline", onClick: runOCR, disabled: !file, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "mr-1 h-4 w-4" }),
          "Extract fields"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ml-auto flex items-center gap-2 text-xs text-white/80", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-[620px] items-center justify-center overflow-auto rounded-md border border-white/20 bg-[#445266] p-3", children: imgSrc ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
          src: imgSrc,
      ...
      ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-white/70", children: "Upload a bill image or PDF to start OCR." }) }),
      progress ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-xs text-white/80", children: progress }) : null
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-3 p-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "details", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "grid w-full grid-cols-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "messages", children: "Messages" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "note", children: "Note" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "history", children: "History" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "details", className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { title: "Item Details" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Type", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Select,
            {
              value: fields.type,
              onValueChange: (v) => setFields((s) => ({ ...s, type: v })),
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Credit note", children: "Credit note" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Order confirmation", children: "Order confirmation" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Statement", children: "Statement" })
                ] })
              ]
            }
          ) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Supplier", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              value: fields.supplier,
              onChange: (e) => setFields((s) => ({ ...s, supplier: e.target.value }))
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Document reference", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              value: fields.documentReference,
              onChange: (e) => setFields((s) => ({ ...s, documentReference: e.target.value }))
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Category", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              ...
              onChange: (e) => setFields((s) => ({ ...s, category: e.target.value }))
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Description", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Textarea,
            {
              ...
              onChange: (e) => setFields((s) => ({ ...s, description: e.target.value }))
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { title: "Amount" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Currency", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Select,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "CAD", children: "CAD - Canada, Dollars" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "USD", children: "USD - US Dollars" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "EUR", children: "EUR - Euro" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "GBP", children: "GBP - Pound" })
                ] })
              ]
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Total amount", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Tax", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              value: fields.taxCode,
              onChange: (e) => setFields((s) => ({ ...s, taxCode: e.target.value }))
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Tax amount", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              value: fields.taxAmount,
              onChange: (e) => setFields((s) => ({ ...s, taxAmount: e.target.value }))
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Net amount", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              value: fields.netAmount,
              onChange: (e) => setFields((s) => ({ ...s, netAmount: e.target.value }))
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { title: "Payment" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between rounded-md border border-border p-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { htmlFor: "paid-switch", children: "Paid" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Switch,
                {
                  id: "paid-switch",
                  checked: fields.paid,
                  onCheckedChange: (checked) => setFields((s) => ({ ...s, paid: checked }))
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground", children: fields.paid ? "Yes" : "No" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Payment method", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              value: paymentMethodLabel,
              onChange: (e) => setFields((s) => ({ ...s, paymentMethod: e.target.value }))
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2 pt-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", variant: "outline", onClick: () => save("To review"), children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(MoveRight, { className: "mr-1 h-4 w-4" }),
              "Move to review"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", onClick: () => save("Ready"), children: [
          ...
          savedReceiptId ? /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-green-600", children: [
            "Saved receipt ID: ",
            savedReceiptId
          ] }) : null
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "messages", className: "text-sm text-muted-foreground", children: "Internal messages can be added here." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "note", className: "text-sm text-muted-foreground", children: "OCR note: validate tax code and payment card ending before final export." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "history", className: "space-y-1 text-xs text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            receipts.length,
            " receipts saved in this workspace."
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("details", { className: "rounded border border-border p-2 text-xs", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("summary", { className: "cursor-pointer font-medium", children: "Raw OCR text" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "mt-2 max-h-36 overflow-auto whitespace-pre-wrap", children: rawText || "No text extracted yet." })
      ] })
    ] }) })
  ] });
}
function Section({ title }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "pt-1 text-xs font-semibold uppercase tracking-wide text-muted-foreground", children: title });
}
function Field({ label, children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { className: "text-xs text-muted-foreground", children: label }),
    children
  ] });
}
function OCRPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ListPage, { title: "Costs Inbox OCR", subtitle: "Upload bill, extract fields, review, and save", children: /* @__PURE__ */ jsxRuntimeExports.jsx(OCRUploader, {}) });
}
export {
  OCRPage as component
};
