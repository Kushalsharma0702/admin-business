import { K as jsxRuntimeExports, V as reactExports, R as React, x as getDefaultExportFromCjs } from "./index.mjs";
...
import { a as fmtMoney } from "./utils-BjL8ABdx.mjs";
import { R as ResponsiveContainer, a as BarChart, C as CartesianGrid, X as XAxis, Y as YAxis, f as Tooltip, B as Bar, b as Cell, l as generateCategoricalChart, v as isFunction, c as Curve, T as Text, h as filterProps, F as polarToCartesian, x as isNil, e as Layer, r as getValueByDataKey, g as adaptEventsOfChild, S as Shape, A as Animate, m as get, t as interpolateNumber$2, u as isEqual, y as isNumber, L as Label, d as LabelList, j as formatAxisMap$1, H as require_baseExtremum, I as require_baseGt, J as require_baseIteratee, K as require_baseLt, M as uniqueId, D as Dot, q as getTickClassName, G as Global, z as mathSign, i as findAllByType, o as getMaxRadius, p as getPercentValue, N as warn } from "./BarChart-DVSAE7pp.mjs";
import { c as clsx } from "./index-De8JtfrF.mjs";
import "node:events";
...
function InsightsPage() {
  ...
  const costsByCategory = Object.entries(costs.reduce((acc, c) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(ListPage, { title: "Insights", subtitle: "Practice analytics overview", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xl font-semibold", children: fmtMoney(totalRevenue) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: "Total Costs" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xl font-semibold", children: fmtMoney(totalCosts) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: "Avg Revenue/Client" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xl font-semibold", children: fmtMoney(avgRevenuePerClient) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: "Hours Logged" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-64", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: tasksByStatus, layout: "vertical", margin: {
          left: 20,
          right: 20
        }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "count", fill: "#4F46E5", radius: [0, 6, 6, 0] })
        ] }) }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold mb-4", children: "Costs by Category" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-64", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Pie, { data: costsByCategory, cx: "50%", cy: "50%", outerRadius: 90, dataKey: "value", nameKey: "name", label: ({
            name,
            value
          }) => `${name}: ${fmtMoney(value)}`, labelLine: false, fontSize: 11, children: costsByCategory.map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: COLORS[i % COLORS.length] }, i)) }),
